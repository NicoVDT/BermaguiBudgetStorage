...
(function () {
  ...
  #bbsChatBox{position:fixed;bottom:92px;right:22px;z-index:9999;width:350px;max-width:92vw;
    ...
    border-radius:14px;overflow:hidden;box-shadow:0 12px 34px rgba(0,0,0,.3);
  ...
  .bbsMsg{margin-bottom:10px;padding:9px 13px;border-radius:13px;max-width:85%;font-size:14px;
    line-height:1.4;white-space:pre-wrap;word-wrap:break-word;}
  .bbsMsg.user{background:#c0510a;color:#fff;margin-left:auto;border-bottom-right-radius:4px;}
  ...
  #bbsChatSend{border:none;background:#c0510a;color:#fff;border-radius:9px;padding:0 15px;
